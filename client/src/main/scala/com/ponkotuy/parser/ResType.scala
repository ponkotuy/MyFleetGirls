...
object ResType extends Log {
  ...
  case object MissionResult extends ResType(s"\\A$ReqMission/result\\z".r)
  ...
  val values = Set(
    ...
    Charge, HenseiChange, HenseiLock, MissionStart, MissionResult,
    KaisouPowerup, Remodeling, Marriage, KaisouLock,
